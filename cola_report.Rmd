...
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - consensus heamtaps for all methods (k = 2), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 2, fun = consensus_heatmap, mc.cores = 4)', 'k = 2', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-consensus-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - consensus heamtaps for all methods (k = 3), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 3, fun = consensus_heatmap, mc.cores = 4)', 'k = 3', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-consensus-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - consensus heamtaps for all methods (k = 4), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 4, fun = consensus_heatmap, mc.cores = 4)', 'k = 4', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-consensus-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - consensus heamtaps for all methods (k = 5), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 5, fun = consensus_heatmap, mc.cores = 4)', 'k = 5', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-consensus-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - consensus heamtaps for all methods (k = 6), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 6, fun = consensus_heatmap, mc.cores = 4)', 'k = 6', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-consensus-heatmap')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - membership heamtap for all methods (k = 2), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 2, fun = membership_heatmap, mc.cores = 4)', 'k = 2', opt = 'fig.width =18, fig.height = 12, results = "hide"', prefix = 'collect-membership-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - membership heamtap for all methods (k = 3), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 3, fun = membership_heatmap, mc.cores = 4)', 'k = 3', opt = 'fig.width =18, fig.height = 12, results = "hide"', prefix = 'collect-membership-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - membership heamtap for all methods (k = 4), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 4, fun = membership_heatmap, mc.cores = 4)', 'k = 4', opt = 'fig.width =18, fig.height = 12, results = "hide"', prefix = 'collect-membership-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - membership heamtap for all methods (k = 5), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 5, fun = membership_heatmap, mc.cores = 4)', 'k = 5', opt = 'fig.width =18, fig.height = 12, results = "hide"', prefix = 'collect-membership-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - membership heamtap for all methods (k = 6), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 6, fun = membership_heatmap, mc.cores = 4)', 'k = 6', opt = 'fig.width =18, fig.height = 12, results = "hide"', prefix = 'collect-membership-heatmap')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - signature heamtap for all methods (k = 2), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 2, fun = get_signatures, mc.cores = 4)', 'k = 2', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-get-signatures')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - signature heamtap for all methods (k = 3), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 3, fun = get_signatures, mc.cores = 4)', 'k = 3', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-get-signatures')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - signature heamtap for all methods (k = 4), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 4, fun = get_signatures, mc.cores = 4)', 'k = 4', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-get-signatures')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - signature heamtap for all methods (k = 5), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 5, fun = get_signatures, mc.cores = 4)', 'k = 5', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-get-signatures')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - signature heamtap for all methods (k = 6), 4 cores", appendLF = FALSE)
knitr_add_tab_item('collect_plots(res_list, k = 6, fun = get_signatures, mc.cores = 4)', 'k = 6', opt = 'fig.width = 18, fig.height = 12, results = "hide"', prefix = 'collect-get-signatures')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 1000, method = "euler")', 'top_n = 1000', opt = 'fig.width = 5, fig.height = 5', prefix = 'top-rows-overlap-by-euler')
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 2000, method = "euler")', 'top_n = 2000', opt = 'fig.width = 5, fig.height = 5', prefix = 'top-rows-overlap-by-euler')
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 3000, method = "euler")', 'top_n = 3000', opt = 'fig.width = 5, fig.height = 5', prefix = 'top-rows-overlap-by-euler')
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 4000, method = "euler")', 'top_n = 4000', opt = 'fig.width = 5, fig.height = 5', prefix = 'top-rows-overlap-by-euler')
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 5000, method = "euler")', 'top_n = 5000', opt = 'fig.width = 5, fig.height = 5', prefix = 'top-rows-overlap-by-euler')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 1000, method = "correspondance")', 'top_n = 1000', opt = 'fig.width = 14, fig.height = 8', prefix = 'top-rows-overlap-by-correspondance')
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 2000, method = "correspondance")', 'top_n = 2000', opt = 'fig.width = 14, fig.height = 8', prefix = 'top-rows-overlap-by-correspondance')
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 3000, method = "correspondance")', 'top_n = 3000', opt = 'fig.width = 14, fig.height = 8', prefix = 'top-rows-overlap-by-correspondance')
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 4000, method = "correspondance")', 'top_n = 4000', opt = 'fig.width = 14, fig.height = 8', prefix = 'top-rows-overlap-by-correspondance')
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 5000, method = "correspondance")', 'top_n = 5000', opt = 'fig.width = 14, fig.height = 8', prefix = 'top-rows-overlap-by-correspondance')
...
knitr_add_tab_item('top_rows_heatmap(res_list, top_n = 1000)', 'top_n = 1000', opt = 'fig.width = 14, fig.height = 3.5', prefix = 'top-rows-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - comparing top row methods by heatmap (top_n = 2000)", appendLF = FALSE)
knitr_add_tab_item('top_rows_heatmap(res_list, top_n = 2000)', 'top_n = 2000', opt = 'fig.width = 14, fig.height = 3.5', prefix = 'top-rows-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - comparing top row methods by heatmap (top_n = 3000)", appendLF = FALSE)
knitr_add_tab_item('top_rows_heatmap(res_list, top_n = 3000)', 'top_n = 3000', opt = 'fig.width = 14, fig.height = 3.5', prefix = 'top-rows-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - comparing top row methods by heatmap (top_n = 4000)", appendLF = FALSE)
knitr_add_tab_item('top_rows_heatmap(res_list, top_n = 4000)', 'top_n = 4000', opt = 'fig.width = 14, fig.height = 3.5', prefix = 'top-rows-heatmap')
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - comparing top row methods by heatmap (top_n = 5000)", appendLF = FALSE)
knitr_add_tab_item('top_rows_heatmap(res_list, top_n = 5000)', 'top_n = 5000', opt = 'fig.width = 14, fig.height = 3.5', prefix = 'top-rows-heatmap')
...
md_list = mclapply(seq_len(nrow(comb)), function(ind) {
    i_section = ind
